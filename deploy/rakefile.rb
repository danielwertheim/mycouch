...
nunit :integrationtests do |nunit|
	nunit.command = "nunit-console.exe"
	nunit.options "/framework=v4.0.30319","/xml=#{@env_buildfolderpath}/NUnit-Report-#{@env_solutionname}-IntegrationTests.xml"
	nunit.assemblies FileList["#{@env_solutionfolderpath}/Tests/#{@env_solutionname}.**IntegrationTests/bin/#{@env_buildconfigname}/#{@env_solutionname}.**IntegrationTests.dll"]
end
